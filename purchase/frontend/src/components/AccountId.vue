<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="accounts" searchParameterName=""  idField="businessRegistrationNumberbusinessRegistrationNumber" nameField="" path="accounts" label="AccountId" v-model="value" @selected="pick" :editMode="editMode" />
